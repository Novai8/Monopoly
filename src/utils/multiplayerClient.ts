...
export class MultiplayerClient {
  ...
  private constructor() {
    try {
      ...
      this.sessionToken = sessionStorage.getItem('tt_session_token');
    } catch (_) {}
  }
  ...
  public leaveRoom() {
    ...
    try {
      sessionStorage.removeItem('tt_room_code');
      sessionStorage.removeItem('tt_player_id');
      sessionStorage.removeItem('tt_session_token');
    } catch (_) {}
    this.cleanupVoice();
  }
