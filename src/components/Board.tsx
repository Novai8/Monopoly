...
import { BoardSize, BoardTheme, BoardTile, Card, OwnershipMap, Player } from '../types';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Ambient theme watermark/glow */}
          <div
            className="absolute inset-0 pointer-events-none opacity-20"
            style={{
              backgroundImage: `radial-gradient(circle at center, ${themeConfig.accentColor} 0%, transparent 70%)`,
            }}
          />

          {/* Top card decks: Chance and Community Chest */}
          <div className="w-full flex items-center justify-between z-10">
            {/* Chance Deck */}
            <div
              className="flex items-center gap-2 p-2 rounded-2xl border shadow-md transition"
              style={{
                backgroundColor: themeConfig.cardSlotBg,
                borderColor: `${themeConfig.accentColor}50`,
              }}
            >
              <div
                className="w-8 h-8 rounded-xl flex items-center justify-center font-black text-white shadow-xs"
          ...
          {/* Middle: 2D Animated Dice & Roll Controls */}
